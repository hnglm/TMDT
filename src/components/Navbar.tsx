      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div 
            ...
            id="brand-logo"
          >
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#5C4033] to-[#D4AF37] flex items-center justify-center text-white font-serif font-black text-xl shadow-md transition-transform group-hover:scale-105">
              L
            </div>
            <div>
          ...
          {/* Nav Links */}
          <div className="hidden lg:flex items-center space-x-1" id="nav-links">
            {[
          ...
          <div className="flex items-center gap-3" id="navbar-controls">
            ...
            {currentUser && (currentUser as any).role === "admin" && (
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-semibold uppercase tracking-wider border transition-all duration-300 ${
                  activeTab === "admin"
            ...
            <button
              ...
              className="relative p-2 rounded-full hover:bg-[#F4EBE1] text-[#4A3B32] transition-colors"
            ...
            {currentUser ? (
              <div className="flex items-center gap-2" id="user-info-section">
                <div 
